...
angular.module('cbApp')
  .controller('SignupCtrl', ["$scope", "Auth", "$location", "$window", "parse", "$state", "$http", function ($scope, Auth, $location, $window,parse,$state, $http) {
    $scope.user = {vehicle:{}};
...
angular.module('cbApp')
  .controller('UserHomeCtrl', ["$scope", "Auth", "$state", function ($scope,Auth,$state) {
    $scope.message = 'Hello';
    $scope.tgState = false;
...
angular.module('cbApp')
  .factory('Auth', ["$location", "$rootScope", "$http", "User", "$cookieStore", "$q", "$localForage", function Auth($location, $rootScope, $http, User, $cookieStore, $q,$localForage) {
    var currentUser = {};
    if($cookieStore.get('token')) {
...
angular.module('cbApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/account/login/login.html',
    "<!-- <div ng-include=\"'components/navbar/navbar.html'\"></div>\r" +
    "\n" +
    "\r" +
    "\n" +
    ...
    "      <h1>Login</h1>\r" +
    "\n" +
    "      <p>Accounts are reset on server restart from <code>server/config/seed.js</code>. Default account is <code>test@test.com</code> / <code>test</code></p>\r" +
    "\n" +
    "      <p>Admin account is <code>admin@admin.com</code> / <code>admin</code></p>\r" +
    "\n" +
    "    </div>\r" +
    "\n" +
    "    <div class=\"col-sm-12\">\r" +
    "\n" +
    "      <form class=\"form\" name=\"form\" ng-submit=\"login(form)\" novalidate>\r" +
    "\n" +
    "\r" +
    "\n" +
    ...
    "\r" +
    "\n" +
    "          <input type=\"email\" name=\"email\" class=\"form-control\" ng-model=\"user.email\" required>\r" +
    "\n" +
    "        </div>\r" +
    "\n" +
    "\r" +
    ...
    "\r" +
    "\n" +
    "          <input type=\"password\" name=\"password\" class=\"form-control\" ng-model=\"user.password\" required>\r" +
    "\n" +
    "        </div>\r" +
    "\n" +
    "\r" +
    "\n" +
    "        <div class=\"form-group has-error\">\r" +
    "\n" +
    "          <p class=\"help-block\" ng-show=\"form.email.$error.required && form.password.$error.required && submitted\">\r" +
    "\n" +
    "             Please enter your email and password.\r" +
    "\n" +
    "          </p>\r" +
    "\n" +
    "          <p class=\"help-block\" ng-show=\"form.email.$error.email && submitted\">\r" +
    "\n" +
    ...
    "\r" +
    "\n" +
    "          <p class=\"help-block\">{{ errors.other }}</p>\r" +
    "\n" +
    "        </div>\r" +
    "\n" +
    "\r" +
    ...
    "        <div>\r" +
    "\n" +
    "          <button class=\"btn btn-inverse btn-lg btn-login\" type=\"submit\">\r" +
    "\n" +
    "            Login\r" +
    "\n" +
    "          </button>\r" +
    "\n" +
    "          <a class=\"btn btn-default btn-lg btn-register\" href=\"/signup\">\r" +
    "\n" +
    "            Register\r" +
    "\n" +
    "          </a>\r" +
    ...
    "        <div>\r" +
    "\n" +
    "          <a class=\"btn btn-facebook\" href=\"\" ng-click=\"loginOauth('facebook')\">\r" +
    "\n" +
    "            <i class=\"fa fa-facebook\"></i> Connect with Facebook\r" +
    "\n" +
    "          </a>\r" +
    "\n" +
    "          <a class=\"btn btn-google-plus\" href=\"\" ng-click=\"loginOauth('google')\">\r" +
    "\n" +
    "            <i class=\"fa fa-google-plus\"></i> Connect with Google+\r" +
    "\n" +
    "          </a>\r" +
    "\n" +
    "          <a class=\"btn btn-twitter\" href=\"\" ng-click=\"loginOauth('twitter')\">\r" +
    "\n" +
    "            <i class=\"fa fa-twitter\"></i> Connect with Twitter\r" +
    "\n" +
    "          </a>\r" +
    "\n" +
    "        </div>\r" +
    ...
    "</div>\r" +
    "\n" +
    " --><div class=page-wrapper><div class=\"container login-container\"><div class=logo-section>Commute Buddy</div><div class=form-section><form class=form name=loginForm novalidate><div class=\"each-row login-page\"><div><span class=\"glyphicon glyphicon-user\"></span></div><div><input ng-class=\"{'error-border':showErrorMessage}\" class=\"form-control input-boxes\" name=empId placeholder=\"Employee ID\" ng-model=user.empId required ng-pattern=\"/^[0-9]*$/\"><div ng-show=showErrorMessage ng-messages=loginForm.empId.$error class=error-msg-edit><p ng-message=required class=error-msg>Please enter Employee number</p><p ng-message=pattern class=error-msg>Please enter valid Employee number</p></div></div></div><div class=\"each-row login-page\"><div><svg xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink version=1.1 id=Layer_1 x=0px y=0px width=512px height=512px viewbox=\"0 0 512 512\" enable-background=\"new 0 0 512 512\" xml:space=preserve><path d=\"M232.969,377.5l-33.938-33.938L315.828,226.75c42.438,22.875,96.25,16.875,132.125-18.938  c43.688-43.75,43.688-114.688,0-158.375c-43.75-43.75-114.688-43.75-158.438,0c-35.813,35.813-41.781,89.688-18.922,132.063  l-229.953,230c-12.453,12.438-12.453,32.813,0,45.25c12.438,12.438,32.813,12.438,45.25,0l33.938,33.938  c6.25,6.25,16.375,6.25,22.625,0l22.625-22.625c6.266-6.25,6.266-16.375,0-22.625L131.141,411.5l22.625-22.688l33.953,34  c6.25,6.25,16.375,6.25,22.625,0l22.625-22.625C239.219,393.875,239.219,383.813,232.969,377.5z M334.766,94.688  c18.75-18.75,49.188-18.75,67.938,0c18.688,18.688,18.688,49.188,0,67.875c-18.75,18.688-49.188,18.688-67.938,0  C316.078,143.875,316.078,113.375,334.766,94.688z\"></svg></div><div><input ng-class=\"{'error-border':showErrorMessage}\" class=\"form-control pwd-boxes\" type=password name=password placeholder=Password ng-model=user.password required><div ng-show=showErrorMessage ng-messages=loginForm.password.$error class=error-msg-edit><p ng-message=required class=error-msg>Please enter password</p></div></div></div><div class=\"each-row login-page\"><input type=button name=continue value=Login ng-click=login()></div></form><a>Forgot password?</a></div></div></div>"
  );
  ...
  $templateCache.put('app/account/signup/signup.html',
    "<div class=page-wrapper><div class=\"container login-container\"><div class=logo-section>COMMUTE BUDDY</div><div class=timeline-section><!-- progressbar --><ul id=progressbar><li ng-class=\"{'active':step==1}\" ng-click=goToStep(1)><a href=\"\">1</a></li><li ng-class=\"{'active':step==2}\" ng-click=goToStep(2)><a href=\"\">2</a></li><li ng-class=\"{'active':step==3}\" ng-click=goToStep(3)><a href=\"\">3</a></li></ul></div><form name=signupForm class=animation-form-signup ng-submit=register() novalidate><div ui-view></div></form></div></div>"
  );


  $templateCache.put('app/account/signup/stepOne/stepOne.html',
    "<div class=form-section><div class=each-row><div class=id-section><svg xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink version=1.1 x=0px y=0px viewbox=\"0 0 96 120\" enable-background=\"new 0 0 96 96\" xml:space=preserve><g><circle cx=26.534 cy=40.515 r=\"7.004\"><path d=\"M15.527,59.833v9.516H37.54v-9.516c0-4.973-4.066-9.039-9.04-9.039h-3.933C19.595,50.794,15.527,54.86,15.527,59.833z\"><rect x=49.881 y=44.751 width=30.592 height=\"5.99\"><rect x=49.881 y=58.575 width=30.592 height=\"5.992\"><rect x=42.206 y=13.954 width=9.46 height=\"16.01\"><path d=\"M86.959,18.046H54.213v6.168h34.92v51.664H6.866V24.214h32.794v-6.168H9.04c-4.973,0-9.04,4.068-9.04,9.039v45.92   c0,4.973,4.067,9.041,9.04,9.041h77.919c4.973,0,9.041-4.068,9.041-9.041v-45.92C96,22.114,91.932,18.046,86.959,18.046z\"></g></svg></div><div><input ng-class=\"{'error-border':!showErrorMessage}\" class=\"form-control input-boxes\" ng-model=user.empId name=empid placeholder=\"Employee ID\" required ng-pattern=\"/^[0-9]*$/\"><div ng-show=!showErrorMessage ng-messages=signupForm.empid.$error class=error-msg-edit><p ng-message=required class=error-msg>Please enter Employee number</p><p ng-message=pattern class=error-msg>Please enter valid Employee number</p></div></div></div><div class=each-row><div><span class=\"glyphicon glyphicon-user\"></span></div><div><input ng-class=\"{'error-border':!showErrorMessage}\" name=empName class=\"form-control input-boxes\" ng-model=user.empName placeholder=Name required ng-pattern=\"/^[a-zA-Z]*$/\"><div ng-show=!showErrorMessage ng-messages=signupForm.empName.$error class=error-msg-edit><p ng-message=required class=error-msg>Please enter name</p><p ng-message=pattern class=error-msg>Please enter valid name</p></div></div></div><div class=each-row><div><span class=\"glyphicon glyphicon-home\"></span></div><div><input ng-class=\"{'error-border':!showErrorMessage}\" name=homeAddress class=\"form-control input-boxes\" ng-model=user.homeAddress placeholder=\"Home Address\" required><div ng-show=!showErrorMessage ng-messages=signupForm.homeAddress.$error class=error-msg-edit><p ng-message=required class=error-msg>Please enter home address</p></div></div></div><div class=each-row><div><span class=\"glyphicon glyphicon-briefcase\"></span></div><div><input name=officeAddress ng-class=\"{'error-border':!showErrorMessage}\" class=\"form-control input-boxes\" ng-model=user.officeAddress placeholder=\"Office Address\" required><div ng-show=!showErrorMessage ng-messages=signupForm.officeAddress.$error class=error-msg-edit><p ng-message=required class=error-msg>Please enter permanent address</p></div></div></div><div class=each-row><input type=button class=input-buttons name=continue value=Continue ng-click=goToStep(2)></div></div>"
  );


  $templateCache.put('app/account/signup/stepThree/stepThree.html',
    "<div class=form-section><div class=vehicle-wrapper><div class=\"each-row seater-section\"><div class=seater-svg><svg xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink version=1.1 x=0px y=0px viewbox=\"0 0 100 125\" enable-background=\"new 0 0 100 100\" xml:space=preserve><g><path fill=\"\" d=\"M88.674,55.613c-1.79-1.751-4.872-4.326-5.966-7.107c-1.094-2.781-3.977-29.766-4.574-33.886   c-0.596-4.12-3.877-8.446-10.141-8.858C64.251,5.516,57.312,5.123,50,5c-7.312,0.123-14.251,0.516-17.994,0.762   c-6.264,0.412-9.545,4.738-10.141,8.858s-3.48,31.105-4.574,33.886c-1.094,2.781-4.176,5.356-5.965,7.107   c-1.79,1.751-3.679,3.399-2.287,12.051s3.171,10.462,4.673,10.712c4.341,0.721,68.51,0.721,72.576,0   c1.499-0.266,3.281-2.06,4.673-10.712C92.353,59.012,90.464,57.364,88.674,55.613z M74.919,60.966   c-4.297,0.836-14.485,0.836-24.588,0.836s-22.774,0.572-25.857-1.767c-3.194-2.423,3.022-8.928,5.471-13.514   c0,0,10.042,5.457,20.386,5.457c10.344,0,19.618-5.457,19.618-5.457S81.506,59.685,74.919,60.966z\"></g><rect x=27.082 y=84.305 fill=#000000 width=45.835 height=\"10.695\"></svg></div><div><select class=seater-select name=capacity ng-class=\"{'error-border':!showErrorMessage}\" required ng-model=user.vehicle.capacity ng-options=\"c as c for c in vehicleCapacityJSON\"><option style=display:none value=\"\">Select Searter</option></select><div ng-show=!showErrorMessage ng-messages=signupForm.capacity.$error class=error-msg-edit><p ng-message=required class=error-msg>Please select vehicle capacity</p></div></div></div><div class=\"each-row seater-section\"><div><svg xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink version=1.1 x=0px y=0px viewbox=\"0 0 50 62.5\" enable-background=\"new 0 0 50 50\" xml:space=preserve><g><path d=\"M40.062,7.404H9.567c-4.587,0-8.317,3.731-8.317,8.317v17.558c0,4.585,3.729,8.316,8.317,8.316h30.495   c4.587,0,8.316-3.731,8.316-8.316V15.721C48.378,11.136,44.648,7.404,40.062,7.404z M46.53,33.279c0,3.566-2.903,6.469-6.469,6.469   H9.567c-3.567,0-6.469-2.902-6.469-6.469V15.721c0-3.567,2.902-6.468,6.469-6.468h30.495c3.565,0,6.469,2.901,6.469,6.468V33.279z\"><path d=\"M32.669,14.899v-0.204c0-1.472-1.198-2.671-2.671-2.671h-8.521c-1.473,0-2.671,1.197-2.671,2.671v0.204   c0,1.472,1.198,2.67,2.671,2.67h8.521C31.471,17.569,32.669,16.372,32.669,14.899z M20.655,14.899v-0.204   c0-0.454,0.368-0.823,0.823-0.823h8.521c0.453,0,0.822,0.369,0.822,0.823v0.204c0,0.454-0.368,0.822-0.822,0.822h-8.521   C21.023,15.721,20.655,15.353,20.655,14.899z\"><path d=\"M20.194,20.341H8.181c-0.255,0-0.462,0.207-0.462,0.463v12.012c0,0.255,0.207,0.463,0.462,0.463h12.013   c0.254,0,0.461-0.208,0.461-0.463V20.804C20.655,20.548,20.448,20.341,20.194,20.341z M19.732,32.354H8.643V21.266h11.089V32.354z\"><path d=\"M40.062,20.341H23.428c-0.255,0-0.461,0.207-0.461,0.463c0,0.254,0.206,0.461,0.461,0.461h16.634   c0.255,0,0.462-0.207,0.462-0.461C40.523,20.548,40.316,20.341,40.062,20.341z\"><path d=\"M23.428,23.114h9.241c0.255,0,0.462-0.207,0.462-0.462c0-0.254-0.207-0.461-0.462-0.461h-9.241   c-0.255,0-0.461,0.207-0.461,0.461C22.966,22.907,23.172,23.114,23.428,23.114z\"><path d=\"M40.062,24.962H23.428c-0.255,0-0.461,0.208-0.461,0.462s0.206,0.462,0.461,0.462h16.634c0.255,0,0.462-0.208,0.462-0.462   S40.316,24.962,40.062,24.962z\"><path d=\"M32.669,27.734c0.255,0,0.462-0.207,0.462-0.462s-0.207-0.462-0.462-0.462h-9.241c-0.255,0-0.461,0.207-0.461,0.462   s0.206,0.462,0.461,0.462H32.669z\"><path d=\"M23.89,29.12c-0.254,0-0.462,0.208-0.462,0.462v3.697c0,0.255,0.208,0.462,0.462,0.462s0.463-0.207,0.463-0.462v-3.697   C24.353,29.328,24.144,29.12,23.89,29.12z\"><path d=\"M25.738,29.12c-0.255,0-0.462,0.208-0.462,0.462v3.697c0,0.255,0.208,0.462,0.462,0.462s0.462-0.207,0.462-0.462v-3.697   C26.2,29.328,25.993,29.12,25.738,29.12z\"><path d=\"M27.587,29.12c-0.256,0-0.463,0.208-0.463,0.462v3.697c0,0.255,0.207,0.462,0.463,0.462c0.254,0,0.462-0.207,0.462-0.462   v-3.697C28.049,29.328,27.841,29.12,27.587,29.12z\"><path d=\"M29.435,29.12c-0.256,0-0.462,0.208-0.462,0.462v3.697c0,0.255,0.206,0.462,0.462,0.462c0.255,0,0.462-0.207,0.462-0.462   v-3.697C29.896,29.328,29.689,29.12,29.435,29.12z\"><path d=\"M31.282,29.12c-0.255,0-0.461,0.208-0.461,0.462v3.697c0,0.255,0.206,0.462,0.461,0.462s0.462-0.207,0.462-0.462v-3.697   C31.744,29.328,31.537,29.12,31.282,29.12z\"><path d=\"M33.131,29.12c-0.256,0-0.462,0.208-0.462,0.462v3.697c0,0.255,0.206,0.462,0.462,0.462c0.254,0,0.463-0.207,0.463-0.462   v-3.697C33.594,29.328,33.385,29.12,33.131,29.12z\"><path d=\"M34.979,29.12c-0.254,0-0.462,0.208-0.462,0.462v3.697c0,0.255,0.208,0.462,0.462,0.462c0.255,0,0.463-0.207,0.463-0.462   v-3.697C35.441,29.328,35.233,29.12,34.979,29.12z\"><path d=\"M36.828,29.12c-0.256,0-0.463,0.208-0.463,0.462v3.697c0,0.255,0.207,0.462,0.463,0.462c0.254,0,0.461-0.207,0.461-0.462   v-3.697C37.289,29.328,37.082,29.12,36.828,29.12z\"><path d=\"M38.676,29.12c-0.256,0-0.462,0.208-0.462,0.462v3.697c0,0.255,0.206,0.462,0.462,0.462c0.254,0,0.462-0.207,0.462-0.462   v-3.697C39.138,29.328,38.93,29.12,38.676,29.12z\"></g></svg></div><div><input class=\"form-control input-boxes\" ng-class=\"{'error-border':!showErrorMessage}\" name=vehicleNo required ng-model=user.vehicle.vehicleNo placeholder=\"Reg. Number\"><div ng-show=!showErrorMessage ng-messages=signupForm.vehicleNo.$error class=error-msg-edit><p ng-message=required class=error-msg>Please enter vehicle registration no</p></div></div></div></div><div class=each-row><div><svg xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink version=1.1 id=Layer_1 x=0px y=0px width=512px height=512px viewbox=\"0 0 512 512\" enable-background=\"new 0 0 512 512\" xml:space=preserve><path d=\"M232.969,377.5l-33.938-33.938L315.828,226.75c42.438,22.875,96.25,16.875,132.125-18.938  c43.688-43.75,43.688-114.688,0-158.375c-43.75-43.75-114.688-43.75-158.438,0c-35.813,35.813-41.781,89.688-18.922,132.063  l-229.953,230c-12.453,12.438-12.453,32.813,0,45.25c12.438,12.438,32.813,12.438,45.25,0l33.938,33.938  c6.25,6.25,16.375,6.25,22.625,0l22.625-22.625c6.266-6.25,6.266-16.375,0-22.625L131.141,411.5l22.625-22.688l33.953,34  c6.25,6.25,16.375,6.25,22.625,0l22.625-22.625C239.219,393.875,239.219,383.813,232.969,377.5z M334.766,94.688  c18.75-18.75,49.188-18.75,67.938,0c18.688,18.688,18.688,49.188,0,67.875c-18.75,18.688-49.188,18.688-67.938,0  C316.078,143.875,316.078,113.375,334.766,94.688z\"></svg></div><div><input class=\"form-control pwd-boxes\" ng-class=\"{'error-border':!showErrorMessage}\" required type=password ng-model=user.password name=password placeholder=Password><div ng-show=!showErrorMessage ng-messages=signupForm.password.$error class=error-msg-edit><p ng-message=required class=error-msg>Please enter password</p></div></div></div><div class=each-row><p>By Signing up, I agree to TCS's <a href=\"\">Terms of Service</a> and <a href=\"\">Privacy Policy</a></p></div><div class=each-row><input type=submit class=submit-buttons name=continue value=\"Sign Up\"></div></div>"
  );


  $templateCache.put('app/account/signup/stepTwo/stepTwo.html',
    "<div class=form-section><div class=each-row><div><span class=\"glyphicon glyphicon-earphone\"></span></div><div><input class=\"form-control input-boxes\" ng-class=\"{'error-border':!showErrorMessage}\" ng-model=user.contactNo name=contactNo required ng-pattern=\"/^[0-9]*$/\" placeholder=Contact><div ng-show=!showErrorMessage ng-messages=signupForm.contactNo.$error class=error-msg-edit><p ng-message=required class=error-msg>Please enter contact number</p><p ng-message=pattern class=error-msg>Please enter valid contact number</p></div></div></div><div class=each-row><div><span class=\"glyphicon glyphicon-time\"></span></div><div><select name=timeSlot class=timeslot ng-model=user.timeSlot ng-class=\"{'error-border':!showErrorMessage}\" required ng-options=\"t as t for t in timeSlotJSON\"><option style=display:none value=\"\">Select timeslot</option></select><div ng-show=!showErrorMessage ng-messages=signupForm.timeSlot.$error class=error-msg-edit><p ng-message=required class=error-msg>Please select timeslot</p></div></div></div><div class=\"each-row gender-section\"><div class=\"radio gender-radio\"><label><input type=radio name=optradio ng-model=user.gender>Male</label></div><div class=\"radio gender-radio\"><label><input type=radio name=optradio ng-model=user.gender>Female</label></div></div><div class=each-row><input type=button class=input-buttons name=continue value=Continue ng-click=goToStep(3)></div></div>"
  );
  ...
  $templateCache.put('app/home/home.html',
    "<div class=\"col-md-12 col-sm-12 col-xs-12 header-section\"><span class=\"glyphicon glyphicon-chevron-left cursor-pointer\" ng-click=toggleHamburger()></span> <span class=heading>Home</span></div><div><img class=\"img-responsive userHome-back\" src=../../assets/images/analytics.png width=320 height=568></div>"
  );
  ...
  $templateCache.put('app/postRides/postRides.html',
    "<div class=page-wrapper><div class=\"container login-container user-home-container pad-R-none pad-L-none\"><div class=\"col-md-12 col-sm-12 col-xs-12 header-section\"><span class=\"glyphicon glyphicon-chevron-left cursor-pointer\" ng-click=toggleHamburger()></span> <span class=heading>Leaving</span></div><div class=\"form-section functionality-wrap\"><div class=\"col-md-12 col-sm-12 col-xs-12 each-function-row\"><div class=input-labels>Leaving In (min)</div><div class=\"window-wrap field-gap-top field-gap-bottom\"><span class=\"each-window selected\">02</span> <span class=each-window>05</span> <span class=each-window>10</span> <span class=each-window>15</span></div></div><div class=\"col-md-12 col-sm-12 col-xs-12 each-function-row\"><div class=input-labels>From</div><div class=\"col-md-12 col-sm-12 col-xs-12 pad-R-none pad-L-none field-gap-top field-gap-bottom\"><input class=\"form-control opp-input-box\"><div class=\"col-md-12 col-sm-12 col-xs-12 pad-R-none pad-L-none field-gap-top field-gap-bottom\"><input type=checkbox id=cb_1 class=other-box><label for=cb_1 class=checkbox-label>OTHER</label><input class=\"form-control opp-input-box show-other\"></div></div></div><div class=\"col-md-12 col-sm-12 col-xs-12 each-function-row no-border\"><div class=input-labels>To</div><div class=\"col-md-12 col-sm-12 col-xs-12 pad-R-none pad-L-none field-gap-top field-gap-bottom\"><input class=\"form-control opp-input-box\"><div class=\"col-md-12 col-sm-12 col-xs-12 pad-R-none pad-L-none field-gap-top field-gap-bottom\"><input type=checkbox id=cb_1 class=other-box><label for=cb_1 class=checkbox-label>OTHER</label><input class=\"form-control opp-input-box show-other\"></div></div></div><div class=each-row><input type=submit class=submit-buttons name=continue value=SUBMIT></div></div></div></div>"
  );


  $templateCache.put('app/userHome/userHome.html',
    "<div class=main-page-wrapper><!-- Hamburger Content --><div class=\"show-none hamburger-content\" ng-class=\"{show : tgState}\"><div class=\"col-md-12 col-sm-12 col-xs-12 hamburger-image-section\"><div class=\"col-md-12 col-sm-12 col-xs-12\"><svg ng-click=toggleHamburger() class=close-hamburger-menu xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink height=32px id=Layer_1 style=\"enable-background:new 0 0 32 32\" version=1.1 viewbox=\"0 0 32 32\" width=32px xml:space=preserve><path d=\"M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z\"></svg></div><div class=user-image-hamburger-wrap><img src=assets/images/user-image.jpg class=avail-user-img> <svg class=user-indication-svg><circle cx=50 cy=50 r=5 class=\"indicator-circle\"></svg></div><p class=hamburger-username>Bob Martin</p><div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12 user-locationham-wrap\"><span class=\"glyphicon glyphicon-map-marker\"></span> <span class=user-location-ham>Pune, Maharashtra</span></div></div><div class=\"col-md-12 col-sm-12 col-xs-12 pad-R-none pad-L-none\"><ul class=functionality-ham-list><li><img src=../../assets/images/1x/ico_post_ride_off.png class=ham-menu-icon> <a class=function-links ui-sref=userHome.home ng-click=toggleHamburger()>POST RIDE</a></li><li><img src=../../assets/images/1x/ico_get_sugg_off.png class=ham-menu-icon> <a class=function-links ui-sref=userHome.postRides ng-click=toggleHamburger()>GET SUGGESTIONS</a></li><li><img src=../../assets/images/1x/ico_sampling_off.png class=ham-menu-icon> <a class=function-links ui-sref=userHome.availableRides ng-click=toggleHamburger()>START SAMPLING</a></li><li><img src=../../assets/images/1x/ico_analyze_off.png class=ham-menu-icon> <a class=function-links ui-sref=main>ANALYZE</a></li><li><img src=../../assets/images/1x/ico_login_off.png class=ham-menu-icon> <a class=function-links ui-sref=main>LOGOUT</a></li></ul></div></div><!-- page content --><div class=main-content ng-class=\"{show : tgState}\"><!-- <hamburger-toggle state=\"tgState\"></hamburger-toggle> --><ui-view></ui-view></div></div>"
  );
